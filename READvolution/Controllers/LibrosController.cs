...
namespace READvolution.Controllers
{
    public class LibrosController : Controller
    {
        ...
        private readonly lServicioLista _servicioLista;
        private readonly lServicioImagen _servicioImagen;
        private readonly IServicioUsuario _servicioUsuario;

        public LibrosController(READvolutionContext context,
            lServicioLista servicioLista, 
            lServicioImagen servicioImagen,
